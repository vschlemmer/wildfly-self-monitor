 ...
 */
public class SelfmonitorDescriptionHandler extends AbstractWriteAttributeHandler<Void> {

    public static final SelfmonitorDescriptionHandler INSTANCE = new SelfmonitorDescriptionHandler();

    private SelfmonitorDescriptionHandler() {
        super(MetricDefinition.DESCRIPTION);
    }
    ...
    protected boolean applyUpdateToRuntime(
        ...
        if (attributeName.equals(SelfmonitorExtension.DESCRIPTION)) {
            ...
            service.changeMetricDescription(metricId, resolvedValue.asString());
